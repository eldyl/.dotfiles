#!/bin/bash
# Install packages
sudo pacman -S ly xorg i3-wm rofi rofi-calc rofimoji pcmanfm xclip xdotool stow \
...
paru -S polybar-git autotiling opensnitch-ebpf-module easyeffects-git \
    deadd-notification-center-bin freetube-bin librewolf-bin syncthingtray
